...
// Language formations configuration (existing system)
...
// Check if a formation is a branch
function isBranchFormation(formation) {
    return branchFormations.includes(formation);
}

// Check if a formation is a language
function isLanguageFormation(formation) {
    return languageFormations.includes(formation);
}

// Get branch configuration
function getBranchConfig(formation) {
    return branchGradingConfig[formation] || null;
}
